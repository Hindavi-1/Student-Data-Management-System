                    ...
                    @foreach ($internships as $internship)
                        <tr class="internship-row">
                            ...
                            <td>
                                ...
                                <!-- Delete Button -->
                                <form method="POST" action="{{ route('internships.destroy', $internship->id) }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
...
<div class="modal fade" id="editInternshipModal" tabindex="-1" aria-labelledby="editInternshipModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editInternshipForm" action="{{ route('internships.update',  $internship->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-header modal-header-custom">
